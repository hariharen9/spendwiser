...
const dateTwoMonthsAgo1 = formatDate(
  new Date(twoMonthsAgo.setDate(twoMonthsAgo.getDate() - 5))
);
const dateTwoMonthsAgo2 = formatDate(
  new Date(twoMonthsAgo.setDate(twoMonthsAgo.getDate() - 10))
);

// Dates for five months back
const fiveMonthsAgo = new Date();
fiveMonthsAgo.setMonth(fiveMonthsAgo.getMonth() - 5);
const dateFiveMonthsAgo1 = formatDate(
  new Date(fiveMonthsAgo.setDate(fiveMonthsAgo.getDate() - 7))
);
const dateFiveMonthsAgo2 = formatDate(
  new Date(fiveMonthsAgo.setDate(fiveMonthsAgo.getDate() - 12))
);
