  ...
  return (
    <div className="space-y-3">
      {transactions.map((transaction) => (
        <motion.div
          key={transaction.id}
          className="bg-white dark:bg-[#242424] rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden"
        ...
        >
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-medium text-gray-900 dark:text-[#F5F5F5] truncate max-w-[140px]">
                  {transaction.name}
                </h3>
