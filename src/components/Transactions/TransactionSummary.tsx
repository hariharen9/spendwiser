    ...
    >
      <div className="p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {/* Bottom Side: Category Chart */}
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h4 className="text-md font-semibold text-gray-900 dark:text-[#F5F5F5] mb-4 text-center">Expense by Category</h4>
            <CategoryChart data={categorySpending} currency={currency} />
          </div>
        </div>
      </div>
    </motion.div>
