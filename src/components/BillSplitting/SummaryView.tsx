      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
          ...
          <p className="text-2xl font-bold text-blue-900 dark:text-blue-100 mt-1">
            {currency}{expenses.reduce((sum, expense) => sum + expense.amount, 0).toFixed(2)}
          </p>
        </div>
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
          <h3 className="font-semibold text-green-800 dark:text-green-200">Total Paid</h3>
          <p className="text-2xl font-bold text-green-900 dark:text-green-100 mt-1">
            {currency}{participants.reduce((sum, p) => sum + p.amountPaid, 0).toFixed(2)}
          </p>
        </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-[#888888]">
                      Paid: {currency}{participant.amountPaid.toFixed(2)} | Owed: {currency}{participant.amountOwed.toFixed(2)}
                    </p>
                  </div>
                </div>
